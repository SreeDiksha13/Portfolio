...
const skills = [
  ...
  { name: "Tableau", level: 90, category: "analytics" },
  { name: "MS Office Suite", level: 90, category: "analytics" },

  // Cloud / Databases
  { name: "MongoDB", level: 65, category: "databases" },
  { name: "AWS", level: 65, category: "databases" },
  { name: "Oracle Cloud Infrastructure", level: 60, category: "databases" },
